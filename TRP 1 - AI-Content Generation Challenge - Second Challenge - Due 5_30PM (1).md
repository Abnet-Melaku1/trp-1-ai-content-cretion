...
1. **Generate Audio Content of your Choice (lyria generates only Instrumental)**
...
2. **Generate Audio Vocals** (if you have AIMLAPI key)  
...
| :---- | :---- | :---- |
| Environment Setup & Configuration | 25 | Successful API setup, working installation |
| Codebase Exploration & Documentation | 25 | Depth of understanding, quality of exploration artifacts |
| Content Generation | 15 | Successfully generated audio/video, creative use of presets |
